...
import { useSignUp, useSignInWithGoogle } from "../../auth/useAuth";

export const SignUpForm: React.FC<{ onSwitchToSignIn: () => void }> = ({
  onSwitchToSignIn,
}) => {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      const message =
        err instanceof Error ? err.message : "Google 注册失败，请重试";
      setError(message);
