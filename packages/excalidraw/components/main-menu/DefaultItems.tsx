...
import { actionOpenRecordingDialog } from "../../actions/actionRecording";
...
export const Recording = () => {
  ...
  if (!actionManager.isActionEnabled(actionOpenRecordingDialog)) {
    return null;
  }
  ...
  return (
    <DropdownMenuItem
      ...
      aria-label={t("recording.openDialog" as any)}
    >
      {t("recording.openDialog" as any)}
    </DropdownMenuItem>
  );
};
