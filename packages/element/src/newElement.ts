...
export const newSlideElement = (
  opts: {
    name?: string;
  } & ElementConstructorOpts,
): NonDeleted<ExcalidrawSlideElement> => {
  const slideElement = newElementWith(
    {
      ..._newElementBase<ExcalidrawSlideElement>("slide", opts),
      type: "slide",
      name: opts?.name || null,
    },
    {},
